 ...
 * generated in the web.wjx package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetCurrentDate_QNAME = new QName("http://wjx.web/", "getCurrentDate");
    private final static QName _GetCurrentDateResponse_QNAME = new QName("http://wjx.web/", "getCurrentDateResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: web.wjx
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wjx.web/", name = "getCurrentDate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://wjx.web/", name = "getCurrentDateResponse")
